...
def calculate_demographic_data(print_data=True):
  ...
  percentage_bachelors = round((bachelors_df['education'].count() /
  ...
  num_min_workers = (min_hours_df['salary'] == '>50K')

  rich_percentage = num_min_workers.mean() * 100

  # What country has the highest percentage of people that earn >50K?
  country_percentages = round(df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts() * 100, 1)
  ...
  india_high_income = high_income_df[high_income_df['native-country'] == 'India']
